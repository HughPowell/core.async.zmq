...
Then we build the big ball of chaos itself
    ...
    git clone https://github.com/HughPowell/core.async.zmq
    cd core.async.zmq
    lein install
    cd ..
...
To report an issue, use the [core.async.smq issue tracker](https://github.com/HughPowell/core.async.zmq/issues) at github.com.
